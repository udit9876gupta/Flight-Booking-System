...
public class FlightController {
    ...
    // public ResponseEntity<FlightsDTO> updateSeats(@PathVariable Integer id,@PathVariable Integer seats, @Valid @RequestBody FlightsDTO flightsDTO) {
    //     return new ResponseEntity<FlightsDTO>(flightService.updateFlightSeats(id,seats, flightsDTO), HttpStatus.ACCEPTED);
    // }
